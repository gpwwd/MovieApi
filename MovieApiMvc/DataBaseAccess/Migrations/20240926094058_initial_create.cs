    ...
    public partial class initial_create : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Kp = table.Column<double>(type: "REAL", nullable: true),
                    Imdb = table.Column<double>(type: "REAL", nullable: true),
                    FilmCritics = table.Column<double>(type: "REAL", nullable: true),
                    RussianFilmCritics = table.Column<double>(type: "REAL", nullable: true),
                    MovieId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
